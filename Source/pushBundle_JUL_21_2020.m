...
% (JFM May 28, 2020)
%
%  See note on the use of two separately specified margins in this
%  function (JFM July 21, 2020)
%
 ...
 for rayIdx = 1:rayBundle.nrays; 
     ...
     %  JFM: should have a separtely specified margin for the
     %  following test...
     %
     indom = inDomain(yTest(:,1:2),rayGd,margin/4);   % column vec of logicals
     badIdxs = find(~indom);
